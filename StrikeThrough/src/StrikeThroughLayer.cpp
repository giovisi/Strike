...
namespace Strike {
	...
	StrikeThroughLayer::StrikeThroughLayer()
		: Layer("StrikeThroughLayer"), m_CameraController(1280.0f / 720.0f, true) {}


	void StrikeThroughLayer::OnAttach() {
	...
	void StrikeThroughLayer::OnDetach() {
		STRK_PROFILE_FUNCTION();
	}

	void StrikeThroughLayer::OnUpdate(Timestep ts) {
		STRK_PROFILE_FUNCTION();
	...
	void StrikeThroughLayer::OnImGuiRender() {
		STRK_PROFILE_FUNCTION();
	...
	void StrikeThroughLayer::OnEvent(Event& e) {
